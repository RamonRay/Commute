...
public class FloorController : MonoBehaviour {
    ...
    public void tiltHorizontal(float leftVoltage, float rightVoltage) {
        motionFloor.outputs[0].Voltage = leftVoltage;
        motionFloor.outputs[2].Voltage = leftVoltage;
        motionFloor.outputs[1].Voltage = rightVoltage;
        motionFloor.outputs[3].Voltage = rightVoltage;
    }


    public void tiltVertical(float frontVoltage, float backVoltage) {
        motionFloor.outputs[2].Voltage = frontVoltage;
        motionFloor.outputs[3].Voltage = frontVoltage;
        motionFloor.outputs[0].Voltage = backVoltage;
        motionFloor.outputs[1].Voltage = backVoltage;
    }
}
